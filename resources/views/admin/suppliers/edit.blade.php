...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <!-- Default box -->
            ...
            <form action="{{route('suppliers.update',['id'=>$sl->id])}}" method="post" enctype="multipart/form-data">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="" value="{{$sl->name}}" 
                                    name="name" >
                                </div>
